...
public class NetheritePlusModelProvider {
    private static void registerBowModels() {
        ItemProperties.register(NETHERITE_BOW.get(), new ResourceLocation("pull"), (itemStack, clientWorld, livingEntity) -> {
        ...
        ItemProperties.register(NETHERITE_BOW.get(), new ResourceLocation("pulling"), (itemStack, clientWorld, livingEntity) -> {
            if (livingEntity == null) {
                return 0.0F;
            }
    ...
    private static void registerCrossbowModels() {
        ItemProperties.register(NETHERITE_CROSSBOW.get(), new ResourceLocation("pull"), (itemStack4, clientWorld3, livingEntity2) -> {
        ...
        ItemProperties.register(NETHERITE_CROSSBOW.get(), new ResourceLocation("pulling"), (itemStack3, clientWorld1, livingEntity1) -> {
        ...
        ItemProperties.register(NETHERITE_CROSSBOW.get(), new ResourceLocation("charged"), (itemStack2, clientWorld4, livingEntity3) -> {
        ...
        ItemProperties.register(NETHERITE_CROSSBOW.get(), new ResourceLocation("firework"), (itemStack1, clientWorld2, livingEntity4) -> {
    ...
    private static void registerElytraModels() {
        ItemProperties.register(NETHERITE_ELYTRA.get(), new ResourceLocation("broken"), (itemStack, clientWorld, livingEntity) -> {
            return ElytraItem.isFlyEnabled(itemStack) ? 0.0F : 1.0F;
        });
    }

    private static void registerFishingRodModels() {
        ItemProperties.register(NETHERITE_FISHING_ROD.get(), new ResourceLocation("cast"), (itemStack, clientWorld, livingEntity) -> {
            if (livingEntity == null) {
                return 0.0F;
            }
    ...
    private static void registerShieldModels() {
        ItemProperties.register(NETHERITE_SHIELD.get(), new ResourceLocation("blocking"), (itemStack, clientWorld, livingEntity) -> {
            return livingEntity != null && livingEntity.isUsingItem() && livingEntity.getUseItem() == itemStack ? 1.0F : 0.0F;
        });
    }

    private static void registerTridentModels() {
        ItemProperties.register(NETHERITE_TRIDENT.get(), new ResourceLocation("throwing"), (itemStack, clientWorld, livingEntity) -> {
            return livingEntity != null && livingEntity.isUsingItem() && livingEntity.getUseItem() == itemStack ? 1.0F : 0.0F;
        });
    }
}
