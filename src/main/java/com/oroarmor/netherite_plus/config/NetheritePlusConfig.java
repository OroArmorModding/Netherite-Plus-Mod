...
public final class NetheritePlusConfig extends Config {
	...
	public static class DAMAGE extends ConfigItemGroup {
		...
		public static final ConfigItem<Double> BOW_DAMAGE_MULTIPLIER = new ConfigItem<>("bow_damage_multiplier",
				1d, "Multiplier of the normal bow damage");
		public static final ConfigItem<Double> CROSSBOW_DAMAGE_ADDITION = new ConfigItem<>(
	...
	public static class DURABILITIES extends ConfigItemGroup {
		public static final ConfigItem<Integer> BOW_DURABILITY = new ConfigItem<>("bow", 768, "Bow Durability");
	...
	public static class ENABLED extends ConfigItemGroup {
		public static final ConfigItem<Boolean> ENABLED_CONFIG_PRINT = new ConfigItem<>("config_debug_print",
		...
		public static final ConfigItem<Boolean> ENABLED_BOWS_AND_CROSSBOWS = new ConfigItem<>(
