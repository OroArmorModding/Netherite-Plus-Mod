...
//			new Item.Settings().maxCount(64).group(ItemGroup.MISC).fireproof()));
	...
	private static void registerShulkerBoxes() {
		...
		NETHERITE_ORANGE_SHULKER_BOX = register(new BlockItem(NetheritePlusBlocks.NETHERITE_ORANGE_SHULKER_BOX,
				NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
		NETHERITE_MAGENTA_SHULKER_BOX = register(new BlockItem(NetheritePlusBlocks.NETHERITE_MAGENTA_SHULKER_BOX,
				NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
		NETHERITE_LIGHT_BLUE_SHULKER_BOX = register(new BlockItem(
				NetheritePlusBlocks.NETHERITE_LIGHT_BLUE_SHULKER_BOX, NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
		NETHERITE_YELLOW_SHULKER_BOX = register(new BlockItem(NetheritePlusBlocks.NETHERITE_YELLOW_SHULKER_BOX,
				NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
		...
		NETHERITE_LIGHT_GRAY_SHULKER_BOX = register(new BlockItem(
				NetheritePlusBlocks.NETHERITE_LIGHT_GRAY_SHULKER_BOX, NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
		...
		NETHERITE_PURPLE_SHULKER_BOX = register(new BlockItem(NetheritePlusBlocks.NETHERITE_PURPLE_SHULKER_BOX,
				NETHERITE_SHULKER_BOX_ITEM_SETTINGS));
