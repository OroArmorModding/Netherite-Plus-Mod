...
public class FishingCategory implements RecipeCategory<FishingDisplay> {

    @Override
    public ResourceLocation getIdentifier() {
        return new ResourceLocation("netherite_plus:fishing_category");
    }

    @Override
    public EntryStack getLogo() {
        return EntryStack.create(Items.FISHING_ROD);
    }
    ...
    @Override
    public RecipeEntry getSimpleRenderer(FishingDisplay recipe) {
